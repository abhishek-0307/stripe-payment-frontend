...
const Payment=()=>{
    ...
    const Paymentfunc= async(event)=>{
       event.preventDefault();
        ...
        const stripe= await loadStripe("pk_test_51PJC7tSIxNC9jnNCIeTukZLi7NLesva0isFz4joxd1hfgdML4LMeeH1WgMYqgrO3M3GuoqYB743S9tc7OFGo0crm00jwKjaSyT")
        ...
        const response=await fetch("https://stripe-payment-backend-vwok.onrender.com/api/create-checkout-session",{
            method:"POST",
            headers:headers,
